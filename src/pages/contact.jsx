    ...
    return (
        <form>
            ...
            <label htmlFor="design-concept">
                Desing Concept <span>If you have one</span>
                <textarea 
                name="design-concept"
                id="design-concept"
                value={designConcept}
...
export default function ContactPage() {
    ...
    const publicKey = import.meta.emv.VITE_EMAIL_JS_PUBLIC_KEY;
    ...
    return (
        <main>
            ...
            <div className="contact">
                <div>
                    <Link to="https://github.com/LalaineHines">
                        <ion-icon name="logo-github"></ion-icon> Github
                    </Link>
                    <Link to ="https://www.linkedin.com/in/LalaineHines">
                ...
                <div>
                    ...
                    setDesignConcept={setDesginConcept}
